...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const calculationRules = {
        ...
        '3party-corporate-simplified': (amount) => (amount / 1.1) / 1.1, // 수정된 계산식
        '3party-tax-exempt-corporate': (amount) => (amount / 1.1) - ((amount * 0.1) * 1.1),
        '3party-tax-exempt-freelancer': (amount) => (amount - (amount * 0.1 * 1.1)) * 0.967,
